...
@section ('title', trans('labels.backend.access.categories.management'))
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.access.categories.all') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>{{ trans('labels.backend.access.categories.table.id') }}</th>
                        <th>{{ trans('labels.backend.access.categories.table.name') }}</th>
                        <th>{{ trans('labels.backend.access.categories.table.code') }}</th>
