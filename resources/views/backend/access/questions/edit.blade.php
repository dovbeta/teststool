...
@section ('title', trans('labels.backend.access.questions.management') . ' | ' . trans('labels.backend.access.questions.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.access.questions.management') }}
        <small>{{ trans('labels.backend.access.questions.edit') }}</small>
    </h1>
@endsection

@section('content')
    {!! Form::model($question, ['route' => ['admin.access.questions.update', $question->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.access.questions.edit') }}</h3>
